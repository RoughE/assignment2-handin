...
var localFs = {
    ...
    //check out recent master code for command line implementation
    //remove here, server and sync-client
    //get the path, get handlers, list files for each directory, delete if in there (look in fs)
}
