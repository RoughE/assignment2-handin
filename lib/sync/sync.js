...
function getFilesBeingOverwritten(path,filesToSync) {
    getDirectoryInfo(path,function(directoryInfo){
        return _.intersection(filesToSync, directoryInfo.fileList);
    })
}
...
module.exports = {
    ...
    getFilesBeingOverwritten:getFilesBeingOverwritten
}
